...
#Training
################################
model = PPO("MlpPolicy", env, verbose=2, tensorboard_log="./logs_graphs/PPO_3DSim_5000000_new_4_3_versiontrial/", policy_kwargs=policy_kwargs)
model.learn(total_timesteps=5000000,reset_num_timesteps=True, tb_log_name="1", callback=event_callback)
model.save("trained_models/sim_model_PPO3_versiontrial")
################################